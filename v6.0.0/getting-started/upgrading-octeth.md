...
2. Download the latest release zip file (e.g., `oempro-rel-v6.0.0.zip`)
3. Upload it to your server:

```bash
scp oempro-rel-v6.0.0.zip root@your-server:/opt/
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v6.0.0.zip
```
...
```text
  Upgrade Summary:
    Version:  v5.9.6 → v6.0.0
    Zip:      oempro-rel-v6.0.0.zip
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v6.0.0.zip --dry-run
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v6.0.0.zip --skip-backup
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v6.0.0.zip --debug
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v6.0.0.zip --force
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v6.0.0.zip --skip-backup --debug
```
