...
2. Download the latest release zip file (e.g., `oempro-rel-v5.9.5.zip`)
3. Upload it to your server:

```bash
scp oempro-rel-v5.9.5.zip root@your-server:/opt/
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.5.zip
```
...
```text
  Upgrade Summary:
    Version:  v5.9.4 → v5.9.5
    Zip:      oempro-rel-v5.9.5.zip
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.5.zip --dry-run
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.5.zip --skip-backup
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.5.zip --debug
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.5.zip --force
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.5.zip --skip-backup --debug
```
