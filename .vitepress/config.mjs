...
export default defineConfig({
    ...
    themeConfig: {
        ...
        nav: [
            {
                text: "v5.9.0",
                items: [
                    {text: 'v5.9.0 (Current)', link: '/v5.9.0/'},
        ...
        sidebar: (() => {
            // Define v5.8.3 sidebar config ONCE
            const v5_9_0_sidebar = [
                {
                    text: 'INTRODUCTION',
                    collapsed: false,
                    items: [
            ...
            return {
                '/': v5_9_0_sidebar,  // Root pages use latest version sidebar
                '/v5.9.0/': v5_9_0_sidebar,  // Reference same config
                '/v5.8.3/': [
                {
                    text: 'INTRODUCTION',
                    collapsed: false,
