...
export default defineConfig({
    ...
    themeConfig: {
        ...
        nav: [
            {
                text: "v5.8.2",
                items: [
                    {text: 'v5.8.2 (Current)', link: '/v5.8.2/'},
        ...
        sidebar: (() => {
            // Define v5.8.2 sidebar config ONCE
            const v5_8_2_sidebar = [
                {
                    text: 'INTRODUCTION',
                    collapsed: false,
                    items: [
            ...
            return {
                '/': v5_8_2_sidebar,  // Root pages use latest version sidebar
                '/v5.8.2/': v5_8_2_sidebar,  // Reference same config
                '/v5.8.1/': [
                {
                    text: 'INTRODUCTION',
                    collapsed: false,
