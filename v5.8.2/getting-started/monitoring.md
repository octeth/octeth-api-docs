...
You will need to use Octeth's `/api/v1/system-health-check` API endpoint. You can learn more about API usage instructions [here](https://dev.octeth.com/v5.8.2/api-reference/system.html#check-system-health).
