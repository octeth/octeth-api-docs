...
The criteria is being used on a few different API end-points including [journey action update](/v5.8.0/api-reference/journeys) and [subscribers](/v5.8.0/api-reference/subscribers).
