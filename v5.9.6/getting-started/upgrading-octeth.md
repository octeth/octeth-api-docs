...
2. Download the latest release zip file (e.g., `oempro-rel-v5.9.6.zip`)
3. Upload it to your server:

```bash
scp oempro-rel-v5.9.6.zip root@your-server:/opt/
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.6.zip
```
...
```text
  Upgrade Summary:
    Version:  v5.9.5 → v5.9.6
    Zip:      oempro-rel-v5.9.6.zip
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.6.zip --dry-run
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.6.zip --skip-backup
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.6.zip --debug
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.6.zip --force
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.6.zip --skip-backup --debug
```
