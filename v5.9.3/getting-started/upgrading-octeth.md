...
2. Download the latest release zip file (e.g., `oempro-rel-v5.9.3.zip`)
3. Upload it to your server:

```bash
scp oempro-rel-v5.9.3.zip root@your-server:/opt/
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.3.zip
```
...
```text
  Upgrade Summary:
    Version:  v5.9.2 → v5.9.3
    Zip:      oempro-rel-v5.9.3.zip
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.3.zip --dry-run
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.3.zip --skip-backup
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.3.zip --debug
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.3.zip --force
```
...
```bash
/opt/octeth/cli/octeth.sh upgrade /opt/oempro-rel-v5.9.3.zip --skip-backup --debug
```
...
rsync -a --checksum --delete \
  /opt/octeth/data/backups/cli.bak.5.9.2.20260729_101500/ \
  /opt/octeth/cli/
```
