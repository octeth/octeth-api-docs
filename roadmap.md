...
::: tip Current Version
The latest stable release is **v5.9.4** (released August 14th, 2026). [View changelog](/changelog#v5-9-4) to see what's new.
:::
...
::: info What's Next?
Octeth ships on a **two-week release cadence**, so expect a new version roughly every fortnight. The next release is due **August 28th, 2026**. **v6.0.0** with major architecture updates is targeted for Q3 2026.
:::
